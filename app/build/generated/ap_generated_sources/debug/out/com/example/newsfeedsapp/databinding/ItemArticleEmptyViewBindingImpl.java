...
public class ItemArticleEmptyViewBindingImpl extends ItemArticleEmptyViewBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.imageViewEmp, 1);
    }
    // views
    // variables
    // values
    ...
    private ItemArticleEmptyViewBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.linearLayoutImage.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.example.newsfeedsapp.ui.main.article.adap.ArticleEmptyItemViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.example.newsfeedsapp.ui.main.article.adap.ArticleEmptyItemViewModel ViewModel) {
